                ...
                if (mapTypeControl[mapType]) {
                    ...
                    for (var i = 0, l = this.shapeList.length; i < l; i++) {
                        ...
                        if (shape._mapType == mapType) {
                            ...
                            if (shapeType == 'path' || shapeType == 'symbol' || shapeType == 'circle' || shapeType == 'rectangle' || shapeType == 'polygon' || shapeType == 'line' || shapeType == 'ellipse') {
                                shape.scale[0] *= delta;
                                shape.scale[1] *= delta;
                            ...
                            } else if (shapeType == 'icon' || shapeType == 'image') {
